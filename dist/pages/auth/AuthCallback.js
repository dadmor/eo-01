...
export const AuthCallback = () => {
    ...
    return (_jsx("div", { className: "min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4", children: _jsx("div", { className: "w-full max-w-md", children: _jsxs(Card, { className: "shadow-xl p-8 text-center", children: [status === 'loading' && (_jsxs(_Fragment, { children: [_jsx("div", { className: "w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4", children: _jsx(LoadingSpinner, { size: "lg" }) }), _jsx("h1", { className: "text-2xl font-bold text-gray-900 mb-4", children: "Potwierdzanie konta..." }), _jsx("p", { className: "text-gray-600", children: "Prosz\u0119 czeka\u0107, przetwarzamy Twoje \u017C\u0105danie." })] })), status === 'success' && (_jsxs(_Fragment, { children: [_jsx("div", { className: "w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4", children: _jsx(CheckCircle, { className: "w-8 h-8 text-green-600" }) }), _jsx("h1", { className: "text-2xl font-bold text-gray-900 mb-4", children: "Sukces!" }), _jsx(Alert, { type: "success", title: "Konto potwierdzone", message: message, className: "mb-4" })] })), status === 'error' && (_jsxs(_Fragment, { children: [_jsx("div", { className: "w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-4", children: _jsx(XCircle, { className: "w-8 h-8 text-red-600" }) }), _jsx("h1", { className: "text-2xl font-bold text-gray-900 mb-4", children: "Wyst\u0105pi\u0142 b\u0142\u0105d" }), _jsx(Alert, { type: "error", title: "B\u0142\u0105d potwierdzenia", message: message, className: "mb-4" }), _jsx("p", { className: "text-sm text-gray-500", children: "Przekierowujemy Ci\u0119 do strony logowania..." })] }))] }) }) }));
};
