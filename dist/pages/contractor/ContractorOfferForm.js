...
export const ContractorOfferForm = () => {
    ...
    const { mutate: createOffer, isPending, error: offerError } = useMutation({
        mutationFn: (data) => contractorApi.createOffer({ ...data, contractor_id: contractorId }),
        onSuccess: () => {
